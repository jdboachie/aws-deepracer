...
def reward_function(params):
    ...
    * speeding up
    ...
    In version three, the model is built with the PPO Algorithm.
    """
    ...
    # Initializing the rSAC(Soft Actor Critic)eward with its default value of 1.0
    reward = 1.0
    ...
    # The reward is reduced a little in this version instead of being cut in half
    if direction_difference > DIRECTION_THRESHOLD:
      reward *= 0.7
    
    # Modifying the reward based on the speed.
    reward *= speed
    return reward